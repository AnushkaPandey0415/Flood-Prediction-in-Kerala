...
x=pd.read_csv(r"C:\Users\ANUSHKA PANDEY\OneDrive\Documents\Woodpeck\disaster prediction ml project\disaster prediction ml project\Flood-prediction-master\approach1\kerala.csv")
